...
export class FollowService {
    ...
    public async follow(user: User, channelId: string) {
        ...
        if(existingFollow) {
            throw new ConflictException('You already subscribted on this channel')
        }
    ...
    public async unfollow(user: User, channelId: string) {
        ...
        if(channel.id === user.id) {
            throw new ConflictException('You cannot unsubscribe to yourself')
        }
        ...
        if(!existingFollow) {
            throw new ConflictException('You not subscribted on this channel')
        }
