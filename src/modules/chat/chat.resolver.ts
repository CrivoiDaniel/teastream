...
import { ChatMessageModel } from './models/chat-meessage.model';
...
export class ChatResolver {
  ...
  @Subscription(() => ChatMessageModel, {name: 'chatMessageAdded', filter: 
  ...
  public async changeSettings(
    ...
    @Args('data') input: ChnangeChatSettingsInput
  ) {
